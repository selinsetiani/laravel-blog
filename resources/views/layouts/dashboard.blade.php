            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav mg-t-15 left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li>                                       
                            <a title="Landing Page" href="/admin" aria-expanded="false" class="{{current_page('admin') ? 'sidebar-active' : '' }}" ><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Dashboard</span></a>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle {{ is_blog() ? 'show' : ''}}" aria-expanded="false">
                                <li><a title="All Professors" href="/mypost" class="{{current_page('mypost') ? 'sidebar-active' : '' }}"><span class="mini-sub-pro">All Post</span></a></li>
                                <li><a title="Add Professor" href="/allpost" class="{{current_page('allpost') ? 'sidebar-active' : '' }}"><span class="mini-sub-pro ">New Post</span></a></li>
                                <li><a title="Edit Professor" href="/categories" class="{{current_page('categories') ? 'sidebar-active' : '' }}"><span class="mini-sub-pro">Categories</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="all-students.html"><span class="mini-sub-pro">All Users</span></a></li>
                                <li><a title="Add Students" href="add-student.html"><span class="mini-sub-pro">Role</span></a></li>
                                <li><a title="Edit Students" href="edit-student.html"><span class="mini-sub-pro">Permissions</span></a></li>
                            </ul>
                        </li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															...
															<span class="admin-name">Setiani</span>
